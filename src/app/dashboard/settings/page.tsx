                    ...
                    <div className='space-y-3'>
                        <div className='flex items-center justify-between'>
                            ...
                            <label className='relative inline-flex cursor-pointer items-center'>
                                ...
                                <div className="peer bg-muted peer-checked:bg-primary h-6 w-11 rounded-full after:absolute after:top-[2px] after:left-[2px] after:h-5 after:w-5 after:rounded-full after:bg-white after:transition-all after:content-[''] peer-checked:after:translate-x-full"></div>
                            </label>
                        </div>
                        <div className='flex items-center justify-between'>
                            <div className='space-y-0.5'>
            ...
            <div className='space-y-4'>
                <div>
                    ...
                    <div className='grid grid-cols-3 gap-4'>
                        <div className='border-primary flex flex-col items-center justify-between rounded-md border-2 p-4'>
